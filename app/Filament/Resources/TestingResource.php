...
class TestingResource extends Resource
{
    ...
    protected static function applyFiltersToQuery(Builder $query, array $filters): void
    {
        //
    }
        ...
        return $form
            ->schema([
                Forms\Components\TextInput::make('name')
                    ->required()
                    ->unique(table: Testing::class, ignoreRecord: true)
                    ->maxLength(255),
    ...
    {
        return [
            TestingResource\Widgets\TestingOverview::class,
        ];
    }
    ...
    public static function getNavigationBadge(): ?string
    {
        ...
        return (string) $modelClass::where('name', 'LIKE', '%test%')->count();
    }
}
